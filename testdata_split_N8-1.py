...
print("len of neighbors_indices8",len(two_hop_neighbors_indices3))
neighbors_indices8=[ele for ele in two_hop_neighbors_indices1 if ele not in two_hop_neighbors_indices4]
neighbors_indices8=[ele for ele in neighbors_indices8 if ele not in one_hop_neighbors_indices6]
