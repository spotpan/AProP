...
def feature_test(adj, features, labels, idx_train, idx_test, flag):
    ...
    for i in range(runs):
        ...
        res=test(adj, innerfeatures, labels, idx_train, idx_test)
        
        clean_acc.append( (f"neighbor{flag+1}", f"sect{i+1}", res) )
...
def main():
    ...
    print('=== feature testing on original(clean) graph ===')
    ...
    #print("idx_test.size", np.asarray(idx_test).shape[0])

    #print("idx_test1",idx_test[0])
    #print("idx_test2",idx_test[1])
    #print("idx_test3",idx_test[2])
    #print("idx_test4",idx_test[3])
    flag=0
    ...
    for list in idx_test:
        ...
        feature_test(adj, features, labels, idx_train, idx_test, flag)
