...
def main():
    ...
    print('=== defending & online mode ===')
    for i in range(runs):
        adaptive_acc.append(test(modified_adj))

    print("adaptive_acc:",adaptive_acc)




    data=pd.DataFrame({"Acc. Clean":clean_acc,"Acc. Perturbed":attacked_acc, "Acc. Defended":adaptive_acc })
