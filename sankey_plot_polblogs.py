...
df = pd.read_csv(
    'sorted_tuples_polblogs.csv',  sep=',',usecols=[0, 1, 3]
...
fig.update_layout(title_text="", font_size=16, width=600, height=300,margin=default_margins)

fig.write_image("pysankey/sankey_polblogs.pdf")
